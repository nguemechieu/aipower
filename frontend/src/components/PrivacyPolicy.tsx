...
const PrivacyPolicy: React.FC = () => {
    ...
    useEffect(() => {
        const fetchPolicies = async () => {
            try {
                const termsResponse = await axiosPublic.get<string[]>("[Your Privacy Policy API Endpoint]");
                const securityResponse = await axiosPublic.get<string[]>("[Your Data Security Policy API Endpoint]");
                const cookieResponse = await axiosPublic.get<string>("[Your Cookie Policy API Endpoint]");
                ...
                setError(err.response.message || "An error occurred while fetching policies.");
            }
        };
    ...
    return (
        <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
            ...
            <p>Effective Date: {
                // Replace with actual effective date
                "2023-01-01"
            ...
            <footer>
                <p>If you have any questions, please contact us at support@aipower.com.</p>
            </footer>
        </div>
    );
};
