...
const HelpPage = () => {
    const faqs = [
        ...
        },
        {
            ...
            answer: "Go to the 'Profile' page from the menu, where you can update your personal information and profile picture.",
        },
        {
            question: "What should I do if I encounter an error?",
            answer: "Please contact our support team with a detailed description of the issue, including any error messages you received.",
        },
        {
            question: "How do I contact customer support?",
            answer: "You can contact customer support by email at support@example.com or by using the 'Contact Us' form below.",
        },
    ];
